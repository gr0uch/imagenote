  ...
  Object.create(Serializer.prototype), {
    ...
    processRequest (context, request) {
      ...
      .then(result => {
        ...
        if (context.request.meta['if-none-match'] === crc32) {
    ...
    showResponse (context, records) {
      ...
      context.response.meta['Content-Type'] = record.mimeType
      context.response.meta['ETag'] = context.response.crc32
      context.response.meta['Cache-Control'] = 'max-age=31536000, public'
